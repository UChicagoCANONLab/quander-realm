...
namespace Wrapper 
{
    public class MapManager : MonoBehaviour 
    {
        ...
        public void InitMap()
        {
            ...
            minigameIcons[(int)Game.Labyrinth].SetInteractable(Events.GetGameUnlocked.Invoke(Game.Labyrinth));
            minigameIcons[(int)Game.Qupcakes].SetInteractable(Events.GetGameUnlocked.Invoke(Game.Qupcakes));
        ...
        public void ResetMap()
        {
            ...
            minigameIcons[(int)Game.Labyrinth].SetInteractable(false);
